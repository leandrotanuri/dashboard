"""
Atualização diária automática — Elisa Lobo
...
def fill_sheet(sheet_name: str, by_date: dict) -> bool:
    ...
    for dt in sorted(by_date.keys()):
        ...
        value_ranges += [
            ...
            # Coluna M = investimento seguidores | Coluna N = seguidores (preenchida manualmente)
...
def main():
    ...
    print(f"=== Atualização diária — Elisa Lobo ===")
